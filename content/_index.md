  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        1. <u>Hirohane Takagi\*</u>, Gouki Minegishi\*, Shota Kizawa, Issey Sukeda, Hitomi Yanaka. (2025, December). Interpreting Multi-Attribute Confounding through Numerical Attributes in Large Language Models. In Proceedings of International Joint Conference on Natural Language Processing & Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL2025).  
        [Paper (Arxiv)](https://arxiv.org/abs/2511.04053), [Code (GitHub)](https://github.com/htkg/num_attrs)
